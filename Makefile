...
rts/librts.a: rts/alloc.o rts/prim.o rts/control.o rts/panic.o rts/string.o rts/main.o
	ar -crs rts/librts.a rts/alloc.o rts/prim.o rts/control.o rts/panic.o rts/string.o rts/main.o
...
rts/string.o: rts/string.c rts/string.h
	clang $(RTSFLAGS) -c rts/string.c -o rts/string.o

rts/main.o: rts/main.c rts/alloc.h rts/control.h rts/panic.h rts/string.h
